...
void *kin_threadfunc(void *arg)
{
	...
	int *user_device_number = (int *)(intptr_t)arg;
...
int main(int argc, char **argv)
{
	...
	res = pthread_create(&kin_thread, NULL, kin_threadfunc, &user_device_number);
	if (res) {
